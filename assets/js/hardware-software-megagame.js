...
function showQuestion() {
  ...
  switch (stage.type) {
    case "hardwareOrSoftware":
      renderHardwareOrSoftwareQuestion(q);
      break;
    case "hardwareScenario":
      renderHardwareScenarioQuestion(q);
      break;
    case "digitiseScenario":
      renderDigitiseScenarioQuestion(q);
      break;
    case "softwareScenario":
      renderSoftwareScenarioQuestion(q);
      break;
    case "dedicatedApps":
      renderDedicatedAppsQuestion(q);
      break;
    case "hardwareSoftwareCombo":
      renderHardwareSoftwareComboQuestion(q);
      break;
    case "eightMarkHardware":
...
function renderHardwareOrSoftwareQuestion(q) {
  questionText.innerHTML =
    "Is this <strong>hardware</strong> or <strong>software</strong>?<br><br>" +
...
function renderHardwareScenarioQuestion(q) {
  questionText.innerHTML =
    "Which hardware is <strong>best</strong> for this situation?<br><br>" +
    "<em>" +
    q.scenario +
    "</em>";
  const options = shuffle(q.options || []);
...
function renderDigitiseScenarioQuestion(q) {
  questionText.innerHTML =
    "Should you use a <strong>digital camera</strong> or a <strong>scanner</strong>?<br><br>" +
    "<em>" +
    q.scenario +
    "</em>";
  const options = shuffle(q.options || []);
...
function renderSoftwareScenarioQuestion(q) {
  questionText.innerHTML =
    "Which software is <strong>best</strong> for this task?<br><br>" +
    "<em>" +
    q.scenario +
    "</em>";
  const options = shuffle(q.options || []);
...
function renderDedicatedAppsQuestion(q) {
  questionText.innerHTML =
    "Which dedicated application would you use?<br><br>" +
    "<em>" +
    q.scenario +
    "</em>";
  const options = shuffle(q.options || []);
...
function renderHardwareSoftwareComboQuestion(q) {
  questionText.innerHTML =
    "Pick the <strong>best hardware + software combination</strong> for this task.<br><br>" +
    "<em>" +
    q.scenario +
    "</em>";
  const options = shuffle(q.options || []);
